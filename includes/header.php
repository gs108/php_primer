...
<div class="container">
  ...
  <ul class="nav">
    ...
    <li class="nav-item"><a class="nav-link" href="dowhileloop.php">Simple Do While</a></li>
    <li class="nav-item"><a class="nav-link" href="ifstatement.php">Simple If Statment</a></li>
    <li class="nav-item"><a class="nav-link" href="switchstatement.php">Simple Switch Statment</a></li>
